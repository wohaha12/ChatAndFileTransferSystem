...
public:
  ...
  bool sendToMetaServer(const ChatSystem::Protocol::TransHeader &header,
                        const QByteArray &data);
  bool sendToStorageServer(const ChatSystem::Protocol::TransHeader &header,
                           const QByteArray &data);
...
signals:
  ...
  void
  metaServerMessageReceived(const ChatSystem::Protocol::TransHeader &header,
                            const QByteArray &data);
  void
  storageServerMessageReceived(const ChatSystem::Protocol::TransHeader &header,
                               const QByteArray &data);
