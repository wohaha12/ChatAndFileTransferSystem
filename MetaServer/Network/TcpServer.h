...
public:
     ...
     * @return 成功返回true，失败返回false
     */
    bool sendData(qintptr socketDescriptor, const Protocol::TransHeader& header, const QByteArray& data);
...
private slots:
     ...
     * @param data 数据包体
     */
    void onMessageReceived(qintptr socketDescriptor, const Protocol::TransHeader& header, const QByteArray& data);
