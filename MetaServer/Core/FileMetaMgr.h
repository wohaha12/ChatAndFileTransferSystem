...
public:
     ...
     */
    bool checkFileExists(const std::string& fileHash, uint64_t fileSize, std::string& storagePath);
     ...
     * @return 文件元数据信息列表
     */
    std::vector<FileMetaInfo> getUserFiles(uint64_t userId, uint64_t parentId = 0);
